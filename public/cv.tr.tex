...
\cvsection{\faBook}{YAYINLAR VE ARAŞTIRMA KATKILARI}
\begin{minipage}{\linewidth}\raggedright
{\ttfamily{}\bfseries{}Türkçe Kültürel Bilgi Veri Seti - MRL 2026 Shared Task}\dates{2026}\par
{\small{}\itshape{}\color{muted}Kabul edilen katkı · Hazırlık aşamasındaki ortak benchmark makalesi}\hfill{\small{}%
\href{https://mrlbenchmarks.github.io/}{\faExternalLink\enspace{}Shared Task}%
}\par\vspace{2pt}
{\fontsize{9}{10}\selectfont{}\raggedright
15 kültürel alanı kapsayan ve kabul edilen Türkçe kültürel bilgi veri setinin kaynaklara dayalı agent pipeline’ını ve veri hazırlama sürecini yönettim. 1.200 aday soru-cevap çiftinin ilk elemesini yaparak 500’ünü Büşra Tufan’ın sosyolojik incelemesine hazırladım; süreç sonunda 300 çiftlik nihai gönderim oluşturuldu. Çağrı Toraman’ın araştırma yönlendirmesiyle yürütülen çalışmada İngilizce çeviri kontrolüne katkı sağladım.\par
\vspace{4pt}Kabul edilen Türkçe veri seti katkım, ortak yazarı olacağım makalede sunulacak çok dilli ve çok modlu benchmark’ın bir parçasını oluşturacak. Ortak veri seti ve preprint’in Ekim 2026’da yayımlanması, shared task sonuçlarının MRL @ EMNLP 2026’da sunulması planlanıyor. Organizatörler makaleyi 2027’de yüksek etkili bir AI yayın mecrasına göndermeyi hedefliyor.\par
}
...
{\fontsize{9}{10}\selectfont{}\raggedright
İTÜ bitirme projemde Qwen tabanlı dil modellerinin finansal akıl yürütme becerilerini araştırdım. Unsloth ve LoRA kullanarak GRPO ile ince ayar yaptım; FinQA ve GSM8K üzerinde ödül tasarımı ve akıl yürütme davranışını inceleyen deneyler yürüttüm. Ollama tabanlı bir sohbet uygulaması da geliştirdim.\par
}
\end{minipage}\par\vspace{2pt}
\begin{minipage}{\linewidth}\raggedright
...
{\fontsize{9}{10}\selectfont{}\raggedright
Türkçe karakter restorasyonunu bayt düzeyinde token sınıflandırması olarak ele alarak ByT5-small modelini PEFT/LoRA ile eğittim. Model eğitimi ve hiperparametre ayarlamasını ağırlıklı olarak üstlendim; hata ayıklama ve Hugging Face Spaces’te yayımlama sürecini ekip arkadaşımla paylaştım. Proje, gürültülü veya yalnızca ASCII karakterleri içeren Türkçe metinlerde ş, ç, ı, ğ, ü ve ö karakterlerinin geri kazandırılmasına odaklandı.\par
}
\end{minipage}\par\vspace{2pt}
\begin{minipage}{\linewidth}\raggedright
...
{\fontsize{9}{10}\selectfont{}\raggedright
ROS2 üzerinde navigasyon ve YOLO tabanlı algıyı birleştiren otonom depo robotunu ekip olarak geliştirdik. Kutuları alma ve bırakma mekanizmasını yaptım; veri etiketlemeyi ekiple birlikte yürüttüm ve diğer algoritmaların geliştirilmesine destek verdim.\par
}
\end{minipage}\par\vspace{2pt}
