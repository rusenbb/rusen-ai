...
/**
 * A BPE tokenizer that runs in the browser via WASM
 */
export class Tokenizer {
     ...
     */
    id_to_token(id) {
        const ret = wasm.tokenizer_id_to_token(this.__wbg_ptr, id);
        let v1;
        if (ret[0] !== 0) {
    ...
    token_to_id(token) {
        ...
        const ret = wasm.tokenizer_token_to_id(this.__wbg_ptr, ptr0, len0);
     ...
     * @returns {string}
     */
    encode_with_info(text) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.tokenizer_encode_with_info(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
     ...
     * @param {string} mergeable_ranks_json
     */
    constructor(mergeable_ranks_json) {
        const ptr0 = passStringToWasm0(mergeable_ranks_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rusenizer_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
