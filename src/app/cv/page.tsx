                  ...
                  <div className={styles.printProjectLogos}>
                    {project.links.map((link) => (
                      ...
                      >
                        ...
                        {link.label === "HF" && (
                          <svg className={styles.printLogo} viewBox="0 0 24 24" fill="currentColor">
                            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm3.5 14.5c-1.5 1.5-4 1.5-5.5 0s-1.5-4 0-5.5c.25-.25.5-.44.78-.59-.03.28.06.57.28.78.34.34.9.34 1.24 0 .34-.34.34-.9 0-1.24-.21-.21-.5-.3-.78-.28.15-.28.34-.53.59-.78 1.5-1.5 4-1.5 5.5 0s1.5 4 0 5.5zm-4-4c-.28 0-.5-.22-.5-.5s.22-.5.5-.5.5.22.5.5-.22.5-.5.5zm4 4c-.28 0-.5-.22-.5-.5s.22-.5.5-.5.5.22.5.5-.22.5-.5.5z"/>
                          </svg>
                        )}
                        {link.label === "▶" && (
                          <svg className={styles.printLogo} viewBox="0 0 24 24" fill="currentColor">
