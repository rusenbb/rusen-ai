...
> *yazan [rusen birben](http://rusenbirben.com) [@fictionstudios](http://fictionstudios.ai)*
...
ML yaklaşımları arasında denetimli öğrenme (etiketli veri kullanarak), denetimsiz öğrenme (etiketsiz veride örüntü bularak) ve pekiştirmeli öğrenme (etkileşim yoluyla öğrenerek) yer alır. ML'yi anlamak, veri gösterimi için doğrusal cebir ([Strang](https://www.youtube.com/playlist?list=PL221E2BBF13BECF6C) & [3B1B](https://www.youtube.com/playlist?list=PLZHQObOWTQDPD3MizzM2xVFitgF8hE_ab)), optimizasyon için kalkülüs ([Tek Değişkenli](https://www.youtube.com/playlist?list=PL590CCC2BC5AF3BC1) & [Çok Değişkenli](https://www.youtube.com/playlist?list=PL4C4C8A7D06566F38) & [3B1B](https://www.youtube.com/playlist?list=PLZHQObOWTQDMsr9K-rj53DwVRMYO3t5Yr)) ve veri analizi için olasılık ve istatistik ([Bertsekas](https://youtube.com/playlist?list=PLUl4u3cNGP60A3XMwZ5sep719_nh95qOe&feature=shared)) bilgisi gerektirir. ML algoritmalarını uygulamak için programlama becerileri, özellikle Python, da gereklidir.
...
- [Google Colab](https://colab.research.google.com/) - TAVSİYE EDİLİR (yerel GPU yoksa)
- [Kaggle](https://kaggle.com/)
- [Andrew Ng's ML Specialization (Coursera)](https://www.coursera.org/specializations/machine-learning-introduction) - ŞİDDETLE TAVSİYE EDİLİR
- [Andrew Ng's ML Course (YouTube, ücretsiz)](https://www.youtube.com/playlist?list=PLkDaE6sCZn6FNC6YRfRQc_FbeQrF8BwGI)
- [3Blue1Brown - Neural Networks](https://www.youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi)
- [Perplexity](https://www.perplexity.ai/) - ŞİDDETLE TAVSİYE EDİLİR
...
1. **Evrişimli Sinir Ağları (CNN'ler):** Bilgisayarlı görü görevlerinin yük beygirleridir. CNN'ler, görüntülerden otomatik olarak öznitelik öğrenmek için evrişim katmanları kullanır; bu da onları görüntü sınıflandırma, nesne tespiti ve görüntü bölütleme gibi görevlerde inanılmaz güçlü kılar.
2. **Yinelemeli Sinir Ağları (RNN'ler):** Bu ağlar sıralı veriyi işlemek için tasarlanmıştır; bu da onları zaman serisi veya doğal dil içeren görevler için ideal kılar. Verideki uzun vadeli bağımlılıkları yakalamada öne çıkan bir RNN türü olan Uzun Kısa Süreli Bellek (LSTM) ağlarına özellikle dikkat et.
3. **Otokodlayıcılar (Autoencoders):** Bu denetimsiz öğrenme modelleri boyut indirgeme ve öznitelik öğrenme için harikadır. Girdi verisini daha düşük boyutlu bir temsile sıkıştırıp ardından onu yeniden inşa ederek çalışırlar.
4. **Çekişmeli Üretici Ağlar (GAN'ler):** Bu büyüleyici mimariler birbirleriyle yarışan iki sinir ağından oluşur ve eğitim kümesine benzeyen yeni, sentetik veri üretmeyi mümkün kılar.
...
- [Deep Learning Specialization (Coursera)](https://www.coursera.org/specializations/deep-learning) (veya dersleri YouTube'da arayabilirsin)
- [3Blue1Brown - Neural Networks](https://youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi&feature=shared)
- [Dive into Deep Learning (d2l.ai)](https://d2l.ai/) (etkileşimli notebook'ları var)
- [Understanding Deep Learning (UDL)](https://udlbook.github.io/udlbook/) (etkileşimli notebook'ları var)
...
1. **Transformer modelleri:** Dikkat (attention) tabanlı bu mimariler doğal dil işlemede devrim yarattı. Öz-dikkat (self-attention) mekanizmasını ve bunun bu modellerin sıralı veride uzun menzilli bağımlılıkları yakalamasını nasıl mümkün kıldığını anla.
2. **Çizge Sinir Ağları (GNN'ler):** Bu modeller çizge yapılı veriyle çalışmak için tasarlanmıştır; bu da onları sosyal ağlar, moleküler yapılar ya da içsel ilişkisel bilgi taşıyan herhangi bir veri içeren görevler için değerli kılar.
3. **Kapsül Ağları (Capsule Networks):** İnsan görsel sisteminden esinlenen bu ağlar, veri içindeki hiyerarşik ilişkileri yakalamayı amaçlar ve geleneksel CNN'lere kıyasla potansiyel olarak daha iyi gürbüzlük ve yorumlanabilirlik sunar.
4. **Nöro-sembolik yapay zeka:** Sinir ağlarını sembolik akıl yürütmeyle birleştiren bu gelişen alan, hem örüntü tanıma hem de mantıksal akıl yürütme yapabilen yapay zeka sistemleri yaratmayı hedefler.
5. **Meta-öğrenme:** "Öğrenmeyi öğrenmek" olarak da bilinen bu yaklaşım, minimum veriyle yeni görevlere hızla uyum sağlayabilen modeller eğitmeyi içerir; daha esnek yapay zeka sistemlerine doğru kritik bir adımdır.

[NeurIPS](https://neurips.cc/), [ICML](https://icml.cc/) ve [ICLR](https://iclr.cc/) gibi en üst düzey konferanslardan makaleleri düzenli olarak okuyarak en güncel araştırmaları takip et. Bu son teknoloji modelleri uygula ve son teknoloji tekniklerle pratik deneyim kazanmak için açık kaynak projelere katkıda bulun.
...
**Bloglar & Dersler:**
- [Anthropic Research](https://www.anthropic.com/research) (yayınları gerçekten iyi)
...
- [Stanford CS231n: Deep Learning for Computer Vision](http://cs231n.stanford.edu/) - O temel kurs
- [First Principles of Computer Vision (YouTube)](https://www.youtube.com/channel/UCf0WB91t8Ky6AuYcQV0CcLw) - klasik CV için mükemmel bir kanal
- [OpenCV Documentation & Tutorials](https://docs.opencv.org/)
- [Ultralytics (YOLO)](https://docs.ultralytics.com/) - pratik nesne tespiti
- [PyImageSearch](https://pyimagesearch.com/) - uygulamalı eğitimler
- [Papers with Code - Computer Vision](https://paperswithcode.com/area/computer-vision) - kıyaslamalar ve son teknoloji
...
- [Stanford CS224N: NLP with Deep Learning](http://web.stanford.edu/class/cs224n/) - O NLP kursu
- [Hugging Face NLP Course](https://huggingface.co/learn/nlp-course) - uygulamalı ve ücretsiz
- [Speech and Language Processing (Jurafsky & Martin)](https://web.stanford.edu/~jurafsky/slp3/) - NLP ders kitabı, çevrimiçi ücretsiz
- [The Illustrated Transformer (Jay Alammar)](https://jalammar.github.io/illustrated-transformer/) - transformer'ların en iyi görsel açıklaması
- [Andrej Karpathy - Let's build GPT (YouTube)](https://www.youtube.com/watch?v=kCc8FmEb1nY) - sıfırdan bir transformer inşa et
- [Attention Is All You Need (orijinal makale)](https://arxiv.org/abs/1706.03762) - bunu oku, bunu anla
- [Zemberek NLP](https://github.com/ahmetaa/zemberek-nlp) - Türkçe NLP araç seti
...
- [Fundamentals of Data Engineering (Joe Reis & Matt Housley)](https://www.oreilly.com/library/view/fundamentals-of-data/9781098108298/) - O veri mühendisliği kitabı
- [DataTalksClub Data Engineering Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp) - ücretsiz, uygulamalı kurs
- [Seattle Data Guy (YouTube)](https://www.youtube.com/@SeattleDataGuy) - pratik veri mühendisliği içeriği
- [Designing Data-Intensive Applications (Martin Kleppmann)](https://dataintensive.net/) - dağıtık sistemler ve verinin incili
- [Mode SQL Tutorial](https://mode.com/sql-tutorial) - mükemmel etkileşimli SQL öğrenimi
